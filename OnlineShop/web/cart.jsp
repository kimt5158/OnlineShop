...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <nav>
                <ul>
                    <li><a href="Controller?page=index&action=back">Home</a></li>
                        <c:choose>
        ...
        <div class="container">
            ...
            <table>
                <tr>
                    ...
                    <th style="width: 100px;">Remove Item</th>
                </tr>
            </table>
                ...
                <c:forEach items="${list }" var="Product">
                    <c:if test="${i == Product.getId() }">
                            ...
                            <table style="table-layout: fixed;width: 100%;">
                                <tr>
                                <input type="hidden" name="proName" value="<c:out value="${Product.getName()}"/>">
                            <td style="width: 100px;"><img src="${Product.getImage()}" height="100" width="150" >  
                                (<c:out value="${Product.getName()}"/>)</td>
                            <td style="width: 50px;"><c:out value="${Product.getPrice()}"/></td>
                            <td style="width: 50px;"><c:out value="${Product.getCategory()}"/></td>
                            <td style="width: 50px;"><input style="width: 40px"  type="text" 
                                                            name="quantity" value="${ Product.getQuantity() }"></td>
                            <td style="width: 100px;"><a href="Controller?page=remove&id=<c:out value="${Product.getId()}"/>"><span class="btn btn-danger">X</span></a></td>
                            </tr>
                        </table>
                        <c:set var="total" value="${total + Product.getPrice()*Product.getQuantity() }"></c:set>
                    </c:if>
                </c:forEach>
            </c:forEach>
            ...
            <a href="Controller?page=index&action=back"><input type="button" value="Continue Shopping" class="btn btn-warning" style="width:100%;padding:8px;font-size:16px;"></a>
