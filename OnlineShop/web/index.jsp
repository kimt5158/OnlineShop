    ...
    <body>
        ...
        <div class="tiazon-content">
            <div class="container">
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <form action="Controller" method="get" style="border: none;margin:0px;padding: 0px;margin-bottom: 20px;">
                                    ...
                                    <input type="hidden" name="action" value="index">
                                    <input type="search" class="search-box" name="search" placeholder="What do you need?">
                        ...
                        <c:forEach items="${ list }" var="product">
                            ...
                            <c:if test="${product.getFeatured() == 'yes' }">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="text-center"><a href="details.jsp?id=${ product.getId() }" style="color: black;"><c:out value="${product.getName() }"></c:out></a></div>	
                    ...
                    <div>
                        ...
                        <c:forEach items="${ listPage }" var="product">
                            <div class="col-md-4">
                                <img src="${product.getImage() }" class="img-responsive" ><br>
                                <div class="text-center"><a href="details.jsp?id=${ product.getId() }" style="color: black;"><c:out value="${product.getName() }"></c:out></a></div>	
                                <p style="text-align: center;"> $  <c:out value="${ product.getPrice() }"></c:out></p>
            ...
            <ul>
                ...
                %>
                <li class="pagination">
                    <a href="Controller?page=index&numPage=<%= j%>"><%= j%></a>
